...
class Fraction {
    ...
    public boolean soSanh(Fraction frn1, Fraction frn2) {
        float A = frn1.numerator / frn1.denominator;
        float B = frn2.numerator / frn2.denominator;
...
public class Bai_5 {
    public static void main(String[] args) {
        ...
        // So sanh
        Fraction psT = new Fraction(3, 4);
        Fraction psTS = new Fraction(3, 5);
        Fraction psC = new Fraction();
        System.out.println("So sanh hai phan so neu dung tra ve true neu khong tra ve false: " + psC.soSanh(psT, psTS));
